...
Una particolare classe rilevante di isomorfismi è quello di \emph{automorfismo}, ovvero un isomorfismo da un gruppo in sé stesso. E' chiaro che l'insieme degli automorfismi sia un gruppo
